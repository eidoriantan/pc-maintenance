...
CREATE TABLE IF NOT EXISTS `accounts` (
  ...
  `password` varchar(72) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'Hashed password',
...
CREATE TABLE IF NOT EXISTS `operations` (
  ...
  `description` text CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL COMMENT 'Operation description and details',
